                  ...
                  <v-card elevation="25">
                    <v-card-text class="map_titulo">
                      <div class="d-flex justify-center white--text">
                        ...
                        <div>Año: {{ selected }}</div>
                <!--Seleccion de año-->

                        <select v-model="selected" >
                          <option disabled value="">Seleccione el año</option>
                          <option v-for="anio in anios" :key="anio" v-on:click="cambiarAnio">{{ anio }}</option>
            ...
            <v-row v-show="expand">
              <v-col cols="12" md="9">
                <span v-bind:key="id_codMapa">
                  <CodMapa :id_1="id_codMapa" :anio="anio" />
                </span>
              </v-col>
              <v-col cols="12" md="3">
                <span :key="numvuelta">
...
export default {
  name: "MapaNacional",
  props: { expand_b: String, expand2_b: String, anio: String },
  beforeUpdate() {
  ...
  data() {
    ...
    return {
      ...
      numvuelta: "2",
      /* */
      //arreglo usado para el codigo del mapa
      id_codMapa: [],
      /*Auxiliares Metodos */
      aux_prov: [],
      aux_prov2: [],
  ...
  methods: {
    ...
    primeraV() {
      ...
      this.id_codMapa = ["1raVuelta", "", "", "",this.selected];
      this.titulo = "Resultados Nacionales "+this.selected;
    ...
    segundaV() {
      ...
      console.log("VueltaNumB2 " + this.numvuelta,this.selected);
      this.id_codMapa = ["2daVuelta", "", "", "",this.selected];
      this.titulo = "Resultados Nacionales "+this.selected;
    },
    ...
    datosBusqueda2() {
      ...
      if (this.select == "") {
        let candidato =
          this.select == ""
            ? (this.id_codMapa = [varVuelta, condicionPartido, "", "",this.selected])
            : "";
    ...
    asignarTitulo() {
      ...
      let condicionTexto =
        this.select2 != "" ? textCanton.nombre : textoTitulo.provincia;
