...
export default {
    ...
    mounted() {
        ...
        if (cm == cm2 && cm != 0) {
            ...
            //provincia.dataSource.url = "Datos/"+ca+ "/"+ cv + "/" + cd + "/" + cm + "/" + cm2 + ".json";
            ...
            canton.dataSource.url = "Datos/"+ca+"/" + cv + "/" + cd + "/" + cm + "/" + cm2 + ".json";
        ...
        paisPolygon.events.on("hit", function (ev) {
            ...
            */
            ...
            //Llamada datos provincia
            var y = ["Datos/"+ca+"/" + cv + "/" + cd + "/" + prov + "/" + devuelta2() + ".json"];
            var aux = y.toString();
            console.log("-------------DATA_PROVINCIA----------------")
            console.log(aux)
            var str = x.toString();
